...
public class Joueur implements Serializable {
	...
	public String toString() {
		...
		sb.append("\n ******************************************* \n");
		sb.append(this.nom + " est à l'echellon " + this.echelonKarmique + " et " + this.anneauxKarmique
				+ " anneaux Karmiques\n");
	...
	/**
	 * Méthode qui permet de piocher une carte dans la pile, pour ensuite la mettre
	...
	/**
	 * Méthode qui permet de savoir si un joueur à le droit de passer son tour. (si
	 * sa pile n'est pas vide)
	 * 
	 * @return passable
	 */
	 ...
	 * On compte les points par couleur, les cartes mosaiques comptes dans toutes
	 * les couleurs.
